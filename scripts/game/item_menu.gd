...
func select_anim(item, pp):
	...
	tween.tween_property(item1, "scale", Vector2(0, 0), 0.5).from(Vector2(1,1)) # Animate position over 1 second
	tween.parallel().tween_property(item1, "position", Vector2(item1.position.x+(item1.size.x/2),item1.position.y+(item1.size.y/2)), 0.5).from(Vector2(item1.position.x, item1.position.y))
	var tween2 = create_tween()
	...
	tween2.tween_property(item2, "scale", Vector2(0, 0), 0.5).from(Vector2(1,1)) # Animate position over 1 second
	tween2.parallel().tween_property(item2, "position", Vector2(item2.position.x+(item2.size.x/2),item2.position.y+(item2.size.y/2)), 0.5).from(Vector2(item2.position.x, item2.position.y))
	var tween3 = create_tween()
	...
	tween3.tween_property(item3, "scale", Vector2(0, 0), 0.5).from(Vector2(1,1)) # Animate position over 1 second
	tween3.parallel().tween_property(item3, "position", Vector2(item3.position.x+(item3.size.x/2),item3.position.y+(item3.size.y/2)), 0.5).from(Vector2(item3.position.x, item3.position.y))
